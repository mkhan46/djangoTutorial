...
class QuestionMethodTests(TestCase):
	...
	def test_was_published_recently_with_future_question(self):
		"""
		was_published_recently() should return False for questions whose pub
		_date is in the future.
		"""
...
self.assertQuerysetEqual(response.context['latest_question_list'], [])
	...
	def test_index_view_with_future_question_and_past_question(self):
		"""
		Even if both past and future questions exist, only past questions hsould be displayed.
		"""
...
class QuestionIndexDetailTests(TestCase):
	def test_detail_view_with_a_futrure_question(self):
	"""
